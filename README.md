...
Technical Approach
Micro-architecture: The AES accelerator will be implemented as a combinatorial logic block integrated directly into the Microwatt execute pipeline stage (execute1.vhdl).

Instruction Decoding: New, unused major opcodes will be assigned to the custom AES instructions in the decode stage (decode1.vhdl).
